...
<div class="row">
  ...
  <div class="col-md-3">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <?php echo do_shortcode('[events_list scope="month" country="US"]<p>#_EVENTLINK <br> <small class="muted">@ #_LOCATIONLINK</small> <br> <small><b>#_EVENTDATES</b> #_EVENTTIMES</small> <br>  #_EVENTEXCERPT{20,...} </p>[/events_list]'); ?>
      </div>
