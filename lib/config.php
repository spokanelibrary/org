 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-21176395-1'); // UA-XXXXX-Y (Note: Universal Analytics only, not Classic Analytics)
...
function roots_display_sidebar() {
  $sidebar_config = new Roots_Sidebar(
    ...
    array(
      'is_404'
      //,'is_front_page'
      ,array('is_tax', 'staff_category', 'kbe_knowledgebase')
