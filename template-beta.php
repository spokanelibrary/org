...
<div class="row">
  ...
  <div class="col-lg-10 col-lg-offset-1">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="panel spl-hero-panel spl-hero-muted" style="background-image: url('http://www.spokanelibrary.org/assets/img/promos/photos/future-study-planning.jpg') no-repeat center center;">
          <div style="padding:16px;">
            <a href="/future-study/">
              ...
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <h2 style="background:transparent;">Your 21<sup>st</sup> century library!</h2>
            </a>
            <div class="row">
              <div class="col-md-6">
              </div>
