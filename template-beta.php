...
<div class="row"> 
  ...
  <div class=" col-sm-12">
    <?php echo do_shortcode('[spl_carousel_beta auto random shuffle news posts promo=learning,digital slug=carousel]'); ?>
  </div><!-- /.col -->

</div><!-- /.row -->


<div class="" style="padding: 0px 0; margin-top: 20px; margin-bottom:20px; border-top: 5px solid rgb(0,85,135); border-bottom: 5px solid rgb(0,85,135);">
...
<div class="row">
  ...
  <div class="col-md-5">
    ...
    <div style="border-top:5px solid #f0ad4e">
      On our calendar
    </div>
