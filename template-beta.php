...
<div class="row"> 
  ...
  <div class="col-sm-12">
    <?php echo do_shortcode('[spl_carousel_beta auto random shuffle news posts promo=tech slug=carousel title="Read. Learn. Discover." ]'); ?>
  </div><!-- /.col -->
  ...
  <div class="col-sm-12">
    ...
    <div class="spl-hero-panel spl-hero-primary">
      ...
      <div class="spl-hero-digital btn-group btn-group-justified" role="group" aria-label="...">
        <a href="/ebooks/" style="height:30px; vertical-align:middle; border:none; border-radius:0;" class="btn btn-primary spl-blue-tint-60">
          <i class="glyphicon glyphicon-phone"></i>
          
          <span class="hidden-xs">&nbsp;<b>eBooks</b> &rarr;</span>
        </a>
        <a href="/emusic/" style="height:30px; vertical-align:middle; border:none;" class="btn btn-primary spl-blue-tint-50">
          <i class="glyphicon glyphicon-music"></i>
          
          <span class="hidden-xs">&nbsp;<b>Music</b> &rarr;</span>
        </a>
        <a href="/eaudio/" style="height:30px; vertical-align:middle; border:none;" class="btn btn-primary spl-blue-tint-40">
          <i class="glyphicon glyphicon-headphones"></i></span>
          
          <span class="hidden-xs">&nbsp;<b>Audio Books</b> &rarr;</span>
        </a>
        <a href="/emagazines/" style="height:30px; vertical-align:middle; border:none; border:none; border-radius:0;" class="btn btn-primary spl-blue-tint-30">
