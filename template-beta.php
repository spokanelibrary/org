...
<div class="row" id="spl-hero"> 
  ...
  <div class="col-sm-12">
    <?php echo do_shortcode('[spl_carousel_beta pause auto random shuffle news posts pages calendar promo=tech slug=carousel title="" ]'); ?>
  </div><!-- /.col -->
  ...
  <div class="col-sm-12">
    ...
    <div class="spl-hero-panel spl-hero-warning">
      ...
      <div class="spl-hero-calendar btn-group btn-group-justified" role="group" aria-label="...">
        <a href="/calendar/storytime/" style="height:40px; vertical-align:middle; border:none; border-radius:0;" class="btn btn-warning spl-hero-link spl-orange-tint-70">
