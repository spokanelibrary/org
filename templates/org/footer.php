<div id="spl-more" style="/*background:rgb(100,150,75);*/">
  ...
  <!-- <a name="spl-more">&nbsp;</a> -->
  <div style="padding-top: 20px; margin-bottom: 20px; background:rgb(100,150,75);">
  ...
  <footer class="content-info container" role="contentinfo">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <p>
          <strong class="text-success" style="">Spokane Public Library</strong>
        </p>
        <address class="text-success" style="">
