  ...
  <div class="col-md-8">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form class="form-horizontal spl-form" id="spl-form-vital" method="post" role="form">
          
          <?php include 'common/crass-response.php'; ?>
      
          <input type="hidden" id="spl-form-id" name="spl-form[id]" value="vital" />
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Please search for</label>
              <div class="col-sm-8">
                <div class="radio">
                  <label>
