...
<div class="form-group">
  ...
  <label for="spl-form-pin" class="col-sm-3 control-label"><span class="hidden-sm">Choose a</span> 4-digit PIN <span class="help-block normal">numbers only!</span></label>
  <div class="col-sm-3">
