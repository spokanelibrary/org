<div class="form-group">
  ...
  <div class="col-sm-3">
    ...
    <input type="text" class="form-control required spl-signup-address-alt" id="spl-form-street-alt-1" name="spl-form[signup][address][street-alt][1]" value="" placeholder="">
    <input type="text" class="form-control required spl-signup-address-alt" id="spl-form-street-alt-2" name="spl-form[signup][address][street-alt][2]" value="" placeholder="">
  </div>
