      ...
      <div class="col-xs-4">
        <p>
          <a class="btn btn-block btn-default btn-sm text-info" 
            href="/about/" 
            title="">
            <i style="border:0px solid #ccc !important; border-radius:4px; padding:2px 3px; margin-top:1px; margin-bottom:-2px; color:#fff; background: rgb(100,150,75);" class="text-success glyphicon glyphicon-thumbs-up"></i>
            <b>Support Us</b></a>
        </p>
      </div><!-- /.col -->
    </div><!-- /.row -->
