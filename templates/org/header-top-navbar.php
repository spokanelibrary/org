          ...
          <div class="row">
            <div class="col-md-11 col-md-offset-1">
              <header id="spl-navbar-common" class="navbar-common navbar-static-top" style="border-left:1px solid rgb(0,85,135); border-right:1px solid rgb(0,85,135);">
                ...
                ?>
                <?php if ( isset($_SESSION['spl']['user']) && !empty($_SESSION['spl']['user']) ) {
                  echo '<li class="menu-logout"><a href="./?logout"><i class="glyphicon glyphicon-log-out text-danger"></i> <span class="hidden-xs hidden-md text-danger">Logout</span></a></li>';
                }
                ?>
                </ul>
                <!--</div>-->
