<?php 
	function get_chof_panel($title=null, $class='', $img=null) {
		...
		if ($img) {
			...
			$html .= '<div style="width:100%; height:100%; top: 0; left: 0; background:#000; opacity:.5;">'.PHP_EOL;
			$html .= '<div style="position:absolute; bottom:0;">'.PHP_EOL;
...
<div class="row">
	...
	<?php echo get_chof_panel('Donald F. Kardong', 'chof-gray', 'http://lorempixel.com/g/200/200/people?8'); ?>
	...
	<?php echo get_chof_panel('Peg Hopkins', 'chof-green', 'http://lorempixel.com/g/200/200/people?12'); ?>
