					...
					<div class="panel-body">	
						...
						<div style="position:relative;">					
							<div style="position:absolute; bottom:0; width:100%; background:#000; opacity:.5; color:#fff;">
								<h5 class="upperecase" style="opacity:1; color:#fff; padding:2px;">'.$title.'</h5>
							</div>
						</div>
					</div>
					'.$link.'
...
<div class="row">
	...
	<?php echo get_chof_panel('Peg Hopkins', 'chof-green', 'http://lorempixel.com/g/1200/200/people?12'); ?>
